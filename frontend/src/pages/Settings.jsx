...
export default function Settings() {
  ...
  // SVG Icons
  const IconPalette = () => (
    <svg className="settings-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
  ...
  const IconUser = () => (
    <svg className="settings-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
  ...
  const IconInfo = () => (
    <svg className="settings-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512" aria-hidden="true" focusable="false">
            ...
            <div className={`p-6 rounded-xl shadow-lg`} style={{ background: 'var(--surface)' }}>
              ...
              <ToggleSwitch
                ...
                label={
                  <span className="flex items-center">
                    <svg className="themed-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 20" style={{ marginRight: '0.5rem' }}>
                      <path fill="currentColor" d="M12.058 20q-3.333 0-5.667-2.334Q4.058 15.333 4.058 12q0-2.47 1.413-4.536t4.01-2.972q.306-.107.536-.056q.231.05.381.199t.191.38q.042.233-.062.489q-.194.477-.282.966t-.087 1.03q0 2.667 1.866 4.533q1.867 1.867 4.534 1.867q.698 0 1.278-.148q.58-.148.987-.24q.217-.04.4.01q.18.051.287.176q.119.125.16.308q.042.182-.047.417q-.715 2.45-2.803 4.014Q14.733 20 12.058 20Zm0-1q2.2 0 3.95-1.213t2.55-3.162q-.5.125-1 .2t-1 .075q-3.075 0-5.238-2.163T9.158 7.5q0-.5.075-1t.2-1q-1.95.8-3.163 2.55T5.058 12q0 2.9 2.05 4.95t4.95 2.05Zm-.25-6.75Z" />
                    </svg>
                    Dark Mode
                  </span>
              ...
              <div className="py-3">
                <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  <svg className="themed-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 32 32" style={{ marginRight: '0.5rem' }}>
                    <circle cx="10" cy="12" r="2" fill="currentColor" />
                    <circle cx="16" cy="9" r="2" fill="currentColor" />
                    <circle cx="22" cy="12" r="2" fill="currentColor" />
                    <circle cx="23" cy="18" r="2" fill="currentColor" />
              ...
              <div className="py-3">
                <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  <svg className="themed-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 15 15" style={{ marginRight: '0.5rem' }}>
        ...
        return (
          <div className="space-y-6">
            <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
              ...
              <div className={`py-3`}>
                <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  <svg className="themed-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style={{ marginRight: '0.5rem' }}>
                    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
                      <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2Z" />
                      <path d="M4.271 18.346S6.5 15.5 12 15.5s7.73 2.846 7.73 2.846M12 12a3 3 0 1 0 0-6a3 3 0 0 0 0 6Z" />
                    </g>
              ...
              <div className="py-3">
                <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  <svg className="themed-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 14" style={{ marginRight: '0.5rem' }}>
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`settings-tab w-full flex items-center text-left px-4 py-3 rounded-lg font-medium transition-all duration-200 group ${
                        isActive
                    ...
                    >
                      <span className="mr-3 flex items-center" aria-hidden="true">{tab.icon}</span>
                      <span>{tab.name}</span>
                    </button>
                  )
                })}
